...
file_handler = logging.FileHandler("D:/Projects/Biomio/prototype-protocol/biomio/algorithms/logs/basic_log.txt")
file_handler.setFormatter(logging.Formatter("%(levelname)-1s" + '\t' + " [%(asctime)s]" + '\t' + " %(message)s"))
logger.addHandler(file_handler)

ext_handler = logging.FileHandler("D:/Projects/Biomio/prototype-protocol/biomio/algorithms/logs/ext_log.txt")
